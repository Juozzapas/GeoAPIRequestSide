...
namespace WebApplication.Controllers
{
    ...
    public class IntersectionController : ControllerBase
    {
        ...
        public IntersectionController(IConfiguration configuration, ICommandCreator creator, IProcessPython python, IHandleOutput outputHandler)
        {
        ...
        public IActionResult Post(InersectionOperationParam myJson)
        {
            var pathToScriptFolder = Configuration["pathToAnalysisScriptFolder"];
            var scriptName = Configuration["AnalysisScriptNames:intersectScript"];
            ...
            using (var tempFiles1 = new TempFileCollection())
            {
                ...
                string args = _creator.buildIntersectionCommand(pathToScriptFolder, scriptName, inputLayerFile, overlayLayerFile);
