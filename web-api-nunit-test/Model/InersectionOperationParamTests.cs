...
{
    [TestFixture]
    public class InersectionOperationParamTests
    {
        ...
        [Test, TestCaseSource(typeof(InersectionOperationParamTests), nameof(ValidationTestCaseData))]
        public void Test_Validate_method(bool inputLayerValid, bool overlayLayerValid, int expectedResultCount)
        {
            ...
            InersectionOperationParam inersectionOperationParam = new InersectionOperationParam() { InputLayer = inputLayer, OverlayLayer = overlayLayer };

            IList<ValidationResult> result = checkPropertyValidation.myValidation(inersectionOperationParam, mockValidationFunctions);
