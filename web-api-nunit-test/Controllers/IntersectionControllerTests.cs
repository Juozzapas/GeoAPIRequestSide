...
namespace web_api_nunit_test.Controllers
{
    public class IntersectionControllerTests
    {
        ...
        private Mock<InersectionOperationParam> inersectionOperationParam;
        private Mock<IntersectionController> intersectionController;
        ...
        public void BeforeEachTest()
        {
            ...
            commandCreator.Setup(x => x.buildIntersectionCommand(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>())).Returns(command);
            ...
            inersectionOperationParam = new Mock<InersectionOperationParam>();
            inersectionOperationParam.Object.InputLayer = "InputLayer" + random.Next(1000);
            inersectionOperationParam.Object.OverlayLayer = "OverlayLayer" + random.Next(1000);

            intersectionController = new Mock<IntersectionController>(configuration.Object, commandCreator.Object, processPython.Object, handleOutput.Object);
            intersectionController.CallBase = true;
        }

        [Test]
        public void Test_Post_CommandBuilder_buildIntersectionCommand_called_once_with_any_parameters()
        {
            intersectionController.Object.Post(inersectionOperationParam.Object);

            Mock.Get(commandCreator.Object).Verify(x => x.buildIntersectionCommand(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()), Times.Exactly(1));
        }

        [Test]
        public void Test_Post_CommandBuilder_buildIntersectionCommand_called_once_with_pathToAnalysisScriptFolder_and_scriptName()
        {
            intersectionController.Object.Post(inersectionOperationParam.Object);

            Mock.Get(commandCreator.Object).Verify(x => x.buildIntersectionCommand(configuration.Object["pathToAnalysisScriptFolder"], configuration.Object["AnalysisScriptNames:bufferScript"], It.IsAny<string>(), It.IsAny<string>()), Times.Exactly(1));
        }
        ...
        {
            IActionResult result = intersectionController.Object.Post(inersectionOperationParam.Object);
